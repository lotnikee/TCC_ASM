...
O_surface = [40500, 36400, 36400]
CO_surface = [172500, 33400, 29700, 29700, 15400, 15400]
O2_dissociation = [99400, 32500, 19400, 17300, 11400]
CO_oxidation = [189600, 54400, 42200, 37000, 35000, 29000, 13400, 9500]
...
vib_O_surface = vibrational_partitions(O_surface, temperature, h_joules, c, boltzmann_joules)
vib_CO_surface = vibrational_partitions(CO_surface, temperature, h_joules, c, boltzmann_joules)
vib_O2_dissociation = vibrational_partitions(O2_dissociation, temperature, h_joules, c, boltzmann_joules)
vib_CO_oxidation = vibrational_partitions(CO_oxidation, temperature, h_joules, c, boltzmann_joules)
